...
#define PROGRAM_VERSION_MAINTENANCE				18
#define PROGRAM_VERSION_BUILD					2

#define PROGRAM_VERSION_STRING "2.10.18.2 FCAMOD"
#define SCRAPER_VERSION_STRING "2.10.18.2"

#define PROGRAM_BUILT_STRING __DATE__ " - " __TIME__

#define RESOURCE_VERSION_STRING "2,10,18,2\0"
