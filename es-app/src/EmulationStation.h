...
#define PROGRAM_VERSION_MAINTENANCE				21
#define PROGRAM_VERSION_BUILD					0

#define PROGRAM_VERSION_STRING "2.10.21.0 BACO"
#define SCRAPER_VERSION_STRING "2.10.21.0"

#define PROGRAM_BUILT_STRING __DATE__ " - " __TIME__

#define RESOURCE_VERSION_STRING "2,10,21,0\0"
