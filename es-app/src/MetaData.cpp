...
void MetaDataList::initMetadata()
{
	...
	{
		// key,             key_name             type,                   default,          statistic,   name in GuiMetaDataEd,  prompt in GuiMetaDataEd,        folder
		{ Name,             "name",              MD_STRING,              "",               false,       "name",                 "enter game name",              true },
		//{ SortName,         "sortname",          MD_STRING,            "",                 false,       "sortname",            "enter game sort name",        true },
		{ Desc,             "desc",              MD_MULTILINE_STRING,    "",               false,       "description",          "enter description",            true },
		{ Emulator,         "emulator",          MD_LIST,                "",               false,       "emulator",             "emulator",                     false },
		{ Core,             "core",              MD_LIST,                "",               false,       "core",                 "core",                         false },
		{ Image,            "image",             MD_PATH,                "",               false,       "image",                "enter path to image",          true },
		{ Video,            "video",             MD_PATH,                "",               false,       "video",                "enter path to video",          false },
		...
		{ Developer,        "developer",         MD_STRING,              "",               false,       "developer",            "enter game developer",         false },
		...
		{ Players,          "players",           MD_INT,                 "",               false,       "players",              "enter number of players",      false },
		{ Favorite,         "favorite",          MD_BOOL,                "false",          false,       "favorite",             "enter favorite off/on",        false },
		{ Hidden,           "hidden",            MD_BOOL,                "false",          false,       "hidden",               "enter hidden off/on",          true },
		{ KidGame,          "kidgame",           MD_BOOL,                "false",          false,       "kidgame",              "enter kidgame off/on",         false },
		{ PlayCount,        "playcount",         MD_INT,                 "0",              true,        "play count",           "enter number of times played", false },
		{ LastPlayed,       "lastplayed",        MD_TIME,                "0",              true,        "last played",          "enter last played date",       false },

		{ Crc32,            "crc32",             MD_STRING,              "",               true,        "crc32",                "crc32 checksum",               false },
		{ Md5,              "md5",               MD_STRING,              "",               true,        "md5",                  "md5 checksum",                 false },
