...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	*/
	...
	addEditableTextComponent("BACKGROUND AUDIO", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	*/
	...
	addGroup(_("CUSTOM IMAGES SETTINGS"));
	// image source
	...
	if (Settings::getInstance()->getBool("ShowFileBrowser"))
		sss_image_dir = addBrowsablePath(_("DIRECTORY"), Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	else
		sss_image_dir = addEditableTextComponent(_("DIRECTORY"), Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	// custom image filter
	auto sss_image_filter = addEditableTextComponent(_("FILTER"), Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
