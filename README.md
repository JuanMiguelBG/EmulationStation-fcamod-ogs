...
```bash
git clone --recursive https://github.com/JuanMiguelBG/EmulationStation-fcamod-ogs.git -b rg503
```

or 

```bash
git clone https://github.com/JuanMiguelBG/EmulationStation-fcamod-ogs.git -b rg503
