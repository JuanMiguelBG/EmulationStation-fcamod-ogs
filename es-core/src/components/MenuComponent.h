...
public:
	...
	void addWithDescription(const std::string& label, const std::string& description, const std::function<void()>& func = nullptr, const std::string iconName = "", const std::string userData = "", bool onButtonRelease = false) { addWithDescription(label, description, nullptr, func, iconName, false, true, false, userData, onButtonRelease); };
	void addWithDescription(const std::string& label, const std::string& description, const std::shared_ptr<GuiComponent>& comp, const std::function<void()>& func = nullptr, const std::string iconName = "", bool setCursorHere = false, bool invert_when_selected = true, bool multiLine = false, const std::string userData = "", bool onButtonRelease = false);
