...
namespace Scripting
{
	...
	{ // private methods
		...
		int fireEvent(const std::string& eventName, bool async, const std::string& arg1, const std::string& arg2, const std::string& arg3, const std::string& arg4)
		{
	...
	int fireEvent(const std::string& eventName, const std::string& arg1, const std::string& arg2, const std::string& arg3, const std::string& arg4)
	{
		...
		return fireEvent(eventName, false, arg1, arg2, arg3, arg4);
	}
	...
	{
		LOG(LogDebug) << "Scripting::fireAsyncEvent() - name: '" << eventName << "', arg1: '" << arg1 << "', arg2: '" << arg2 << "', arg3: '" << arg3 << "', arg4: '" << arg4 << "'";
		return fireEvent(eventName, true, arg1, arg2, arg3, arg4);
	}
